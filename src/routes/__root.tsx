...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rifa Andraca — Gana la Chevrolet S10 MAX 2024" },
      { name: "description", content: "Participa en la Rifa Andraca. Sorteo el 25 de agosto de 2026 con base en la Lotería Nacional. Boletos desde $50 pesos." },
      { property: "og:title", content: "Rifa Andraca — Chevrolet S10 MAX 2024" },
      { property: "og:description", content: "Aparta tus boletos en línea y participa por una Chevrolet S10 MAX 2024 seminueva blanca." },
